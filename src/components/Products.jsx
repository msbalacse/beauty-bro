      ...
      <Grid container spacing={2}>
        ...
        <Grid item md={6}>
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm">
              Exclusively Bridal is a premier bridal boutique dedicated to
              providing an exceptional and personalized shopping experience for
              brides-to-be. The boutique prides itself on offering an extensive
              collection of designer wedding gowns, bridesmaid dresses, and
              bridal accessories that cater to various styles, preferences, and
              budgets.
            </p>
            <ul className="p-4 text-sm list-disc">
              <li className="">
                A diverse selection of wedding dresses from renowned designers.
              </li>
              <li>
                Styles ranging from classic and timeless to modern and trendy.
              </li>
              <li>
                Customization options to ensure a perfect fit and unique look.
              </li>
            </ul>
          </div>
        </Grid>
        ...
        <Grid item md={6}>
          ...
          <p className="text-sm">
            ...
            ratione fugit inventore. Exercitationem soluta delectus suscipit
            quisquam nemo aliquid mollitia libero consequatur dolores facere
            fugit rem, velit omnis tempore maxime.
          </p>
        </Grid>
